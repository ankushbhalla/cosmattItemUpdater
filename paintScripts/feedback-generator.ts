...
import { ContentFormatPipe } from '../components/scoring/pipes/content-format.pipe';
...
export class FeedbackGenerator {
    private finalDocData;
    private cellData: any;
    private cellRef: string; // sheetId!cell
    ...
    generateFeedback(validationRule) {
        ...
        let feedbackTemplate: string = feedbackRepo.initialText;
        let feedbackPropValue: string;
        /* 
    ...
    getFormattedContent(content, format) {
        let contentFormatPipe = new ContentFormatPipe();
        return contentFormatPipe.transform(content,format).toString().trim();
    }
