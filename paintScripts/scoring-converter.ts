...
export class ScoringConverter {
     ...
     */
    public convertToPublishFormat(
        scoringJson, 
        finalGridJson: {activeSheet: string, defaults: any, sheets: any},
        skipScorerJson = false
    ): {scoringJson?: any, solutionJson: {activeSheet: string, defaults: any, sheets: any}} {
    ...
    private convertToScorerFormat(scoringJson) {
        /*
    ...
    private getAllValidationRules(scoringJson) {
    ...
    private addRuleToGridJson(rule, finalGridJson) {
